...
import { type GeneratedContent, type Prompt, useContent } from '../../hooks/useContent';
          ...
          {selectedWorkspace ? (
            ...
            <div className="flex-1 flex items-center justify-center">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Select a workspace</h3>
                <p className="text-gray-600">
                  Choose a workspace from the sidebar to view and manage your prompts and generated
                  content
                </p>
              </div>
            </div>
